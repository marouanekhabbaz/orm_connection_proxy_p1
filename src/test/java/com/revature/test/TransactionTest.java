...
public class  TransactionTest {
	...
	static public Transaction tx = new  Transaction();
	...
	public void test5() throws SQLException {
		Object row = tx.update(Car.class, "color = 'white' ", 2);
	...
	// update already deleted
		...
		public void test6() throws SQLException {
			Object row = tx.update(Car.class, "color = 'white' ", 10000);
		...
		public void test7() throws SQLException {
			List<Object> rows = tx.update(Car.class, "color = 'white' ", " price = 24  ");
		...
		public void test9() throws SQLException {
			int id = tx.delete(Car.class , 10000000);
			assertEquals(0, id);
		}
